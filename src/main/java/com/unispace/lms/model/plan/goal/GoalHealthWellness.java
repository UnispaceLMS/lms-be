...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_health_wellness")
public class GoalHealthWellness {
  @Id
  ...
  @CollectionTable(name = "goal_health_wellness_entry")
  private List<GoalHealthWellnessEntry> healthWellnessEntries;

  @Transient
  public static void prepareForUpsert(
      GoalHealthWellness newEntity, GoalHealthWellness existingEntity) {
