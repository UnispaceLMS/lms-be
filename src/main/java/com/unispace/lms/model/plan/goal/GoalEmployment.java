...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_employment")
public class GoalEmployment {
  @Id
  ...
  @CollectionTable(name = "goal_employment_entry")
  private List<GoalEmploymentEntry> employmentEntries;

  @Transient
  public static void prepareForUpsert(GoalEmployment newEntity, GoalEmployment existingEntity) {
