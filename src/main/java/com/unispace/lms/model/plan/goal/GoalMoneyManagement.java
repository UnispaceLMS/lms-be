...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_money_management")
public class GoalMoneyManagement {
  @Id
  ...
  @CollectionTable(name = "goal_money_management_entry")
  private List<GoalMoneyManagementEntry> moneyManagementEntries;

  @Transient
  public static void prepareForUpsert(
      GoalMoneyManagement newEntity, GoalMoneyManagement existingEntity) {
