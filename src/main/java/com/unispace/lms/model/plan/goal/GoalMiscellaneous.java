...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_miscellaneous")
public class GoalMiscellaneous {
  @Id
  ...
  @CollectionTable(name = "goal_miscellaneous_entry")
  private List<GoalMiscellaneousEntry> miscellaneousEntries;

  @Transient
  public static void prepareForUpsert(
      GoalMiscellaneous newEntity, GoalMiscellaneous existingEntity) {
