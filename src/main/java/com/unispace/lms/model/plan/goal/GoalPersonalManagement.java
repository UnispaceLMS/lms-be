...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_personal_management")
public class GoalPersonalManagement {
  @Id
  ...
  @CollectionTable(name = "goal_personal_management_entry")
  private List<GoalPersonalManagementEntry> goalPersonalManagementEntries;

  @Transient
  public static void prepareForUpsert(
      GoalPersonalManagement newEntity, GoalPersonalManagement existingEntity) {
