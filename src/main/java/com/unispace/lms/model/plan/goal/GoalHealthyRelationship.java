...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_healthy_relationship")
public class GoalHealthyRelationship {
  @Id
  ...
  @CollectionTable(name = "goal_healthy_relationship_entry")
  private List<GoalHealthyRelationshipEntry> healthyRelationshipEntries;

  @Transient
  public static void prepareForUpsert(
      GoalHealthyRelationship newEntity, GoalHealthyRelationship existingEntity) {
