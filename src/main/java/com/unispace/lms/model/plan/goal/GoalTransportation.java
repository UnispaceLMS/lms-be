...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "goal_transportation")
public class GoalTransportation {
  @Id
  ...
  @CollectionTable(name = "goal_transportation_entry")
  private List<GoalTransportationEntry> transportationEntries;

  @Transient
  public static void prepareForUpsert(
      GoalTransportation newEntity, GoalTransportation existingEntity) {
